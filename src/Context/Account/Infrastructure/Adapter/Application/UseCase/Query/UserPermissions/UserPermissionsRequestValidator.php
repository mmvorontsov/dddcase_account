...
namespace App\Context\Account\Infrastructure\Adapter\Application\UseCase\Query\UserPermissions;
...
use App\Context\Account\Application\UseCase\Query\UserPermissions\{
    ...
    UserPermissionsRequestValidatorInterface,
};
...
/**
 * Class UserPermissionsRequestValidator
 * @package App\Context\Account\Infrastructure\Adapter\Application\UseCase\Query\UserPermissions
 */
final class UserPermissionsRequestValidator extends AbstractRequestValidator implements
    UserPermissionsRequestValidatorInterface
{
    /**
    ...
    /**
     * UserPermissionsRequestValidator constructor.
