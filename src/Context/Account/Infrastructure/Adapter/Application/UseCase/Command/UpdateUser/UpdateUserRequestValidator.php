...
namespace App\Context\Account\Infrastructure\Adapter\Application\UseCase\Command\UpdateUser;
...
use App\Context\Account\Application\UseCase\Command\UpdateUser\UpdateUserRequestValidatorInterface;
 ...
 * @package App\Context\Account\Infrastructure\Adapter\Application\UseCase\Command\UpdateUser
 */
final class UpdateUserRequestValidator extends AbstractRequestValidator implements
    UpdateUserRequestValidatorInterface
{
    /**
            ...
            [
                'fields' => [
                    ...
                    'firstname' => new Assert\Optional(
                        [
                            new Compound\FirstnameCompound(),
                        ],
                    ),
                ],
